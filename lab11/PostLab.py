...
img = Image.open("G:\sem-3\python_lab\lab11\Screenshot 2025-08-31 163932.png")
...
img = Image.open("G:\sem-3\python_lab\lab11\Screenshot 2025-08-31 163932.png").convert("RGB")
img_array = np.array(img)
