...
audio_fs,audio=wavfile.read(r"G:\sem-3\python_lab\lab18\audio.wav")
ir_fs,ir=wavfile.read(r"G:\sem-3\python_lab\lab18\impulse.wav")
...
circular_conv=np.fft.fft(audio_fft*ir_fft)
