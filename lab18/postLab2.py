...
fs1,clean=wavfile.read(r"G:\sem-3\python_lab\lab18\clean_audio.wav")
fs2,noisy=wavfile.read(r"G:\sem-3\python_lab\lab18\noisy_audio.wav")
fs3,periodic=wavfile.read(r"G:\sem-3\python_lab\lab18\periodic_audio.wav")
